...
urlpatterns = [
    ...
    # OCPP - EV Central System - Charge Point interaction
    ...
    url(r'^save_cp_energy/?$', api.save_CP_energy_consumption,
        name="save_cp_energy"),
    url(r'^authorize_user/?$', api.authorize_user, name="authorize_user"),
    url(r'^cp_status_update/?$', api.update_CP_status,
        name="cp_status_update"),
